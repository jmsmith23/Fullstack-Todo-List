  ...
  const createTodo = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator(function* () {
      ...
      try {
        ...
        const createdTodo = yield response.json(); // createdTodo = json object
        const todosCopy = [createdTodo, ...todos]; // add createdTodo to front of the list
        setTodos(todosCopy); // updated
        setNewTodo({
          // clears create todo form
          title: '',
          completed: false
        });
      } catch (error) {
...
/******/ })()
;
//# sourceMappingURL=App.48e405eb3a921ed833f78488201dd56f.js.map